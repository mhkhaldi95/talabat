                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">{{$item->created_at}}</td>
                                    </tr>
                                    <!--end::Date-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <div class="d-flex align-items-center justify-content-end">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <a href="#" class="text-gray-600 text-hover-primary">{{$item->user->name}}</a>
                                                <!--end::Name-->
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <div class="d-flex align-items-center justify-content-end">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <a href="#" class="text-gray-600 text-hover-primary">{{$item->branch->address}}</a>
                                                <!--end::Name-->
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a href="#" class="text-gray-600 text-hover-primary">{{$item->branch->user->email}}</a>
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    <!--begin::Date-->
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-50px">
                                                <span class="symbol-label" style="background-image:url({{$ite->product->avatar}});"></span>
                                            </a>
                                            <!--end::Thumbnail-->
                                            <!--begin::Title-->
                                            <div class="ms-5">
                                                <a href="#" class="fw-bolder text-gray-600 text-hover-primary">{{$ite->product->name}}</a>
{{--                                                <div class="fs-7 text-muted">Delivery Date: 30/03/2022</div>--}}
                                    ...
                                    <!--begin::Quantity-->
                                    <td class="text-end">{{$ite->quantity}}</td>
                                    <!--end::Quantity-->
                                    <!--begin::Price-->
                                    <td class="text-end">{{$ite->price}}</td>
                                    <!--end::Price-->
                                    <!--begin::Total-->
                                    <td class="text-end">{{$ite->quantity * $ite->price}}</td>
                                    <!--end::Total-->
                                    @php
...
{{--                                </tr>--}}
                                <tr>
                                    ...
                                    <td class="text-end">{{$item->calculateDiscount()}}</td>
                                </tr>
                                <!--end::VAT-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark fs-3 fw-boldest text-end">{{$item->price}}</td>
                                </tr>
                                <!--end::Grand total-->
                                </tbody>
                                <!--end::Table head-->
