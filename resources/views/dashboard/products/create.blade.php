                                            ...
                                            @foreach($branches as $branch)
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-4 fv-row">
                                                        <input type="text" name="qty[{{$branch->id}}][]" class="form-control form-control-lg form-control-solid" placeholder="Company website" value="{{isset($item)?$branch->getQty($item['id']):0}}" />
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
