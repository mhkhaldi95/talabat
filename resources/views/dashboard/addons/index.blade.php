                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <!--begin::Add customer-->
                            <a href="{{route('addons.create')}}" type="button" class="btn btn-primary" >{{__('lang.add')}}</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                        ...
                        },
                        {
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/admin/addons/create/${row.id}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        {{__('lang.Edit')}}
                                    </a>
                                </div>
                                <!--end::Menu item-->
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        axios.post('/admin/addons/'+record_id+'/delete').then(function (response) {
                                            dt.draw();
                                        })
                                    });
                                });
                        ...
                        if (result.value) {
                            ...
                            Swal.fire({
                                ...
                                Swal.fire({
                                    ...
                                    // delete row data from server and re-draw datatable
                                    axios.post('/admin/addons/delete-selected',{'ids':ids}).then(function (response) {
                                        dt.draw();
                                    })
                                });
