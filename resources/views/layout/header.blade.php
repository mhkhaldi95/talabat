                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="{{route('admins.account.create',\Auth::id())}}"
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                ...
                                <a href="#" class="menu-link px-5">
													...
													<img class="w-15px h-15px rounded-1 ms-2"
                                                         src="{{app()->getLocale() == 'ar'?asset('assets/media/flags/saudi-arabia.svg'):asset('assets/media/flags/united-states.svg')}}"
                                                         alt=""/></span></span>
                                </a>
                                <!--begin::Menu sub-->
                            ...
                            <div class="menu-item px-5">
                                <a href="{{route('logout')}}" onclick=" window.localStorage.removeItem('fcm_token')"
                                   class="menu-link px-5">{{__('lang.sign_out')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
