        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    ...
                    @if(auth()->user()->isAbleTo(['categories-create', 'categories-read']))
                    ...
                    @if(auth()->user()->isAbleTo(['products-create', 'products-read']))
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											<span class="menu-link">
												...
												<span class="menu-title">{{__('lang.addons')}}</span>
												<span class="menu-arrow"></span>
											</span>
                            <div class="menu-sub menu-sub-accordion">
                                @if(auth()->user()->isAbleTo(['products-read']))
                                ...
                                @if(auth()->user()->isAbleTo(['products-create']))
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('addons.create')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                                            <span class="menu-title">{{__('lang.add')}}</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    <div class="menu-item">
                        <div class="menu-content pb-2">
                            <span class="menu-section text-muted text-uppercase fs-8 ls-1">{{__('lang.user_management')}}</span>
                        </div>
                    </div>
                    <span class="menu-link">
										...
										<span class="menu-title">{{__('lang.user_management')}}</span>
										<span class="menu-arrow"></span>
									</span>
                ...
                <div class="menu-item">
                    ...
                    @if(auth()->user()->isAbleTo(['settings-create', 'settings-read']))
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											<span class="menu-link">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                @if(auth()->user()->isAbleTo(['settings-create']))
                                    <div class="menu-item">
