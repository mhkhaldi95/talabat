                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.Status') }} ({{__('lang.admin')}})</th>
                            <th class="min-w-125px">{{__('lang.Status')}} ({{__('lang.branch')}})</th>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $("#datatable").DataTable({
                    ...
                    ajax: {
                        ...
                        url: "{{route('branch.products.index')}}",
                    },
                    columns: [
                        { data: 'id' },
                        { data: 'name' },
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    Swal.fire({
                                        ...
                                        axios.post('/branch/products/'+record_id+'/delete').then(function (response) {
                                            dt.draw();
                                        })
                        ...
                        if (result.value) {
                            ...
                            Swal.fire({
                                ...
                                Swal.fire({
                                    ...
                                    // delete row data from server and re-draw datatable
                                    axios.post('/branch/products/delete-selected',{'ids':ids}).then(function (response) {
                                        dt.draw();
                                    })
                                });
            ...
            $(document).on('click','.change_status',function (e) {
                ...
                axios.post('{{route('change-status')}}',{status:status,product_id:product_id}).then(function (response) {
